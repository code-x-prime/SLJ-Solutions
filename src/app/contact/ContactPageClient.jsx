...
import {
    ...
    Instagram, Linkedin, Facebook, Download
} from 'lucide-react';
                                    ...
                                    <div className="space-y-10">
                                        ...
                                        <div>
                                            <button
                                                ...
                                                className="inline-flex items-center gap-2 px-6 py-3 bg-transparent border-2 border-[#ED2028] text-[#ED2028] 
                                                         font-nav text-sm uppercase tracking-wider
                                                         hover:bg-[#ED2028] hover:text-white transition-colors w-full justify-center"
                                            >
                                                <Download size={16} />
                                                Download Brochure
                                            </button>
